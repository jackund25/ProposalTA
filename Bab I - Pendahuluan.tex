...
Berdasarkan permasalahan tersebut, penelitian ini difokuskan untuk menelusuri bagaimana konsep digital twin dapat disederhanakan dan diterapkan secara kontekstual di Indonesia, khususnya dalam mendukung prediksi kadar glukosa darah pasien diabetes tipe 2 berbasis data simulatif.
...
\begin{enumerate}
    ...
    \item Bagaimana mengembangkan model prediktif kadar glukosa darah berbasis data simulatif dari dataset publik menggunakan pendekatan pembelajaran mesin?
...
\begin{enumerate}
    ...
    \item Mengembangkan modul prediktif kadar glukosa berbasis pembelajaran mesin (LSTM atau Random Forest) yang dapat beroperasi menggunakan data minimal dari dataset simulatif publik.
