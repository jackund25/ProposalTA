...
\begin{tabular}{ | p{2.8cm} | p{3.8cm} | p{3.5cm} | p{4.5cm} | }
\hline
...
Penerapan \textit{Digital Twin} dalam konteks Indonesia menghadapi beberapa hambatan struktural. Pertama, tingkat kesiapan teknologi informasi dan komunikasi (TIK) antar fasilitas kesehatan masih bervariasi \cite{Aisyah2024}. Kedua, perangkat medis pendukung seperti \textit{Continuous Glucose Monitoring (CGM)} dan pompa insulin masih tergolong mahal dan belum tersedia secara luas \cite{Ramadaniati2024}. 
